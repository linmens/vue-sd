<template>
    ...
    <el-form  :model="formItem" label-position="top" label-width="80">
        <el-form-item label="入股人">
            <el-input v-model="formItem.tblink"></el-input>
        </el-form-item>
        <el-form-item label="入股金额">
            <el-input type="number" v-model="formItem.name" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="入股项目">
    ...
    export default {
      ...
      methods:{
        ...
        pattrn(){
          ...
          this.$http.post('http://www.a10store.com/api/caiwu/check_goods_url.php', {
        ...
        tosendLoading(){
          ...
          this.$http.post('http://www.a10store.com/api/caiwu/goods_add_new.php', {
            addform:this.formItem,
